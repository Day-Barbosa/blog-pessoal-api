...
class UsuarioControllerTest {
    ...
    void deveCadastrarUsuario() {
        ...
        Usuario usuario = TestBuilder.criarUsuario(null, "Paulo Antunes",
                "paulo_antunes@email.com.br", "12345678");
    ...
    @Test
    @DisplayName("02 - Nao deve permitir a duplicacao do usuario")
    ...
    @Test
    @DisplayName("03 - Deve atualizar os dados de um usuario com sucesso")
    void deveAtualizarUmUsuario() {
        ...
        Usuario usuarioUpdate = TestBuilder.criarUsuario(
                cadastrado.get().getId(), "Juliana Ramos", "ju_ramos@email.com.br", "12345678");
